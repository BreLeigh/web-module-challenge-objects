...
// console.log(reviews('Reyna', 5 ,`this place is chill with really cool people, great for getting work done on weekdays`));
...
function getReviewByIndex(array, number) {
  return `${array[number].name} gave the restaurant a ${array[number].rating} star review, and their feedback was: Beautiful atmosphere and wonderful vegan options!` 
}
...
function getLastReview(array) {
  return `${array[array.length -1].name} gave the restaurant a ${array[array.length -1].rating} star rating, and their feedback was: ${array[array.length]}`
} 
